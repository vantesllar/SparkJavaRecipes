...
public class PredictingHowManyVideosWillCustomerWatchNextMonth {
     ...
     * 2. Replace any nulls in firstSub, all_time_views, last_month_views and next_month_views
     * 3. Build a Linear Regression model using all available fields other than the date (3.0)
     *  3.1. Encode all categorical data into vectors
     *  3.2. Use pipelines if desired
     *  3.3. Use a range of model fitting parameters to minimize r2
     *  3.4. Use 90/10 splits for holdout and for test
     */
...
//                .config("spark.sql.warehouse.dir", "file:///Users/ivan/Desktop/tmp/") // macOS
        ...
        Dataset<Row> dataSet = session.read()
                ...
                .withColumn("next_month_views", when(col("next_month_views").isNull(), 0).otherwise(col("next_month_views"))); // 2

...
/**
 * This class serves to produce test data for the classes ViewingFiguresDStreamVersion and ViewingFiguresStructuredVersion
 */
public class ViewReportsSimulatorForBothViewingFigures
{
